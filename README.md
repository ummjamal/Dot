# الشعيبي لإدارة البقالة — V4 Ultimate
...
## V4 Ultimate (4.0.0)
تضيف V4 تدفق دفع كامل (نقدي/تحويل/خصم/باقي)، إلغاء فاتورة يعيد المخزون، سجل تدقيق محلي، فلاتر مخزون، مؤشرات مالية محسّنة، وتحسينات واجهة واستقرار. لا يستخدم التطبيق Firebase ويعمل محلياً دون إنترنت.
