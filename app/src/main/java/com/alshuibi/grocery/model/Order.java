...
public class Order {
    ...
    public void setDiscountAmount(long discountAmount) { this.discountAmount = Math.max(0, discountAmount); }
    public long getPaidAmount() { return paidAmount; }
    public void setPaidAmount(long paidAmount) { this.paidAmount = Math.max(0, paidAmount); }
    public long getChangeAmount() { return changeAmount; }
    public void setChangeAmount(long changeAmount) { this.changeAmount = Math.max(0, changeAmount); }
