...
import com.alshuibi.grocery.BuildConfig;
import com.alshuibi.grocery.R;
import com.alshuibi.grocery.data.local.GroceryDatabase;
import com.alshuibi.grocery.utils.BackupManager;
...
public class SettingsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextInputEditText receiptFooter = view.findViewById(R.id.settingsReceiptFooter);
        TextInputEditText password = view.findViewById(R.id.settingsPassword);
        TextView securityWarning = view.findViewById(R.id.settingsSecurityWarning);
        ...
        TextView lifetimeSales = view.findViewById(R.id.settingsLifetimeSales);
        TextView lifetimeProfit = view.findViewById(R.id.settingsLifetimeProfit);
        TextView inventoryValue = view.findViewById(R.id.settingsInventoryValue);
        ...
        save.setOnClickListener(v -> {
            ...
            String footerValue = String.valueOf(receiptFooter.getText()).trim();
            ...
            try (GroceryDatabase db = new GroceryDatabase(requireContext())) {
                ...
                db.setSetting("receipt_footer", footerValue.isEmpty() ? "شكرًا لتسوقكم من " + storeValue : footerValue);
